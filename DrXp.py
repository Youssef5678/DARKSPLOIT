...
O = '\033[0;33m' # Orange
B = '\033[1;34m' #Blue
os.system("cd banner;python2 banner4.py;python2 banner1.py;python2 banner2.py;python2 banner3.py;python2 banner.py;python2 banner5.py")
print
print
print ""+N+"       =[ "+O+"DarkSploit v.2 by Youssef_HR"+N+"                   ]"
print "+ -- --=[ 14 Exploits - 10 Scanners 16 post - 38 virus   ]"
print "+ -- --=[ facebook:    youssef anfinif "+N+"                  ]"
print "+ -- --=[ Youtube     "+R+"     Termux learn "+N+"                 ]"
print
def help():
		print ""+N+""
...
def main():
	...
	if dr == "show options":
		...
		print "make virus/on_android_rf                 Sat, December 23     virus"
		print "make virus/on_android_wana_decp          Sat, December 23     virus"
		print "make virus/on_android_wanadecryptor2     Sat, December 23     virus"
		print "joomla_simple_shell                      Thu, December 26    exploits"
		print "make virus/on_android_dangerous_malware  Sat, December 28    virus"
		print "make virus/on_android_malware            Sat, December 28    virus"
		print "make virus/on_android_malware_enc        Sat, December 28    virus"
		print "make virus/on_android_malware_door       Sat, December 28    virus"
		print "make virus/on_android_malware_at         Sat, December 28    virus"
		print "make virus/on_android_trojan_malware     Sat, December 28    virus"
		print "make virus/on_android_brother            Sat, December 28    virus"
		print "make virus/on_android_mcef               Sat, December 28    virus"
		print "make virus/on_android_sms_tief           Sat, December 28    virus"
		print "----------"
		print
		main()
	elif dr == "clear":
		...
		main()
			...
			print "make virus/on_android_rf                manual       nothing"
			print "make virus/on_android_wana_decp          good        wanna decryptor"
			print "make virus/on_android_wanadecryptor2     good        wanna decryptor v2"
			print "make virus/on_android_dangerous_malware  high        malware"
			print "make virus/on_android_malware            high        malware"
			print "make virus/on_android_malware_enc        good        malware"
			print "make virus/on_android_malware_door       high        trojan"
			print "make virus/on_android_malware_at         high        malware"
			print "make virus/on_android_trojan_malware     good        malware"
			print "make virus/on_android_brother            manual      malware"
			print "make virus/on_android_mcef               manual      malware"
			print "make virus/on_android_sms_tief           manual      malware"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/DarkXploit/virus/rf/"
			time.sleep(1)
			print ""+B+"[*]"+N+" Job finished"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/DarkXploit/virus/Wannadecryptor/"
			time.sleep(1)
			print ""+B+"[*]"+N+" Job finished"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/DarkXploit/virus/dangerous-malware/"
			time.sleep(1)
			print ""+B+"[*]"+N+" Job finished"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/DarkXploit/virus/malware_enc/"
			time.sleep(1)
			print ""+B+"[*]"+N+" Job finished"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/DarkXploit/virus/malware_bnews/"
			time.sleep(1)
			print ""+B+"[*]"+N+" Job finished"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/DarkXploit/virus/malware_at/"
			time.sleep(1)
			print ""+B+"[*]"+N+" Job finished"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/DarkXploit/virus/trojan_malware/"
			time.sleep(1)
			print ""+B+"[*]"+N+" Job finished"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/DarkXploit/virus/brother/"
			time.sleep(1)
			print ""+B+"[*]"+N+" Job finished"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/DarkXploit/virus/mcef/"
			time.sleep(1)
			print ""+B+"[*]"+N+" Job finished"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/DarkXploit/virus/sms_tief/"
			time.sleep(1)
			print ""+B+"[*]"+N+" Job finished"
			main()
